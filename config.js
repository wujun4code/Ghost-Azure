...
if (!websiteUrl || websiteUrl === '' || websiteUrl.length === 0) {
  websiteUrl = 'http://' + process.env.siteName + '.chinacloudsites.cn';
...
config = {
  ...
  production: {
    ...
    database: {
      client: 'mysql',
      connection: {
        host: 'leanengineghostresearch.mysqldb.chinacloudapi.cn',
        user: 'leanengineghostresearch%ghost',
        password: 'Gp@ssw0rd',
        database: 'node_ghost_blog',
        charset: 'utf8'
      }
    },
    server: {
